...
public class CetakDataRawatJalan extends javax.swing.JFrame {

    public void Cetak() {
        String html = "<H4><center>Laporan Data Rawat Jalan Puskesmas</center></h4>" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CetakDataRawatJalan.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CetakDataRawatJalan().setVisible(true);
            }
        });
    }
