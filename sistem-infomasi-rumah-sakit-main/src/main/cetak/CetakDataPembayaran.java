...
public class CetakDataPembayaran extends javax.swing.JFrame {

    public void Cetak(){
        String html = "<H4><center>Laporan Data Pemeriksaan Pasien Puskesmas</center></h4>"+
                "<table width='98%' border='0' align='center' cellpadding='5' cellspacing='1'>"+
                    "<tr>"+
                        "<td bgcolor='#CCCCCC' align='center'><strong>Kode Pembayaran</Strong></td>"+
                        ...
                        "<td bgcolor='#CCCCCC' align='center'><strong>Spesialis</Strong></td>"+
                        "<td bgcolor='#CCCCCC' align='center'><strong>Tindakan</Strong></td>"+
                        "<td bgcolor='#CCCCCC' align='center'><strong>Total Biaya</Strong></td>"+
                        "<td bgcolor='#CCCCCC' align='center'><strong>Pembayaran</Strong></td>"+
                        "<td bgcolor='#CCCCCC' align='center'><strong>Kembalian</Strong></td>"+
                    "<tr>";
        ...
        try{
            ...
            while(res.next()){
                html = html + 
                    "<tr>" +
                        "<td bgcolor='#EEEEEE'>"+res.getString("id")+"</td>"+
                        ...
                        "<td bgcolor='#F8F8F8'>"+res.getString("nama_spesialis")+"</td>"+
                        "<td bgcolor='#F8F8F8'>"+res.getString("tindakan")+"</td>"+
                        "<td bgcolor='#F8F8F8'>"+res.getString("pembayaran.harga")+"</td>"+
                        "<td bgcolor='#F8F8F8'>"+res.getString("pembayaran")+"</td>"+
                        "<td bgcolor='#F8F8F8'>"+res.getString("kembalian")+"</td>"+
                    "</tr>";
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CetakDataPembayaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CetakDataPembayaran().setVisible(true);
            }
        });
    }
