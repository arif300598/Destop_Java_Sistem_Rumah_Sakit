...
public class CetakDataRawatInap extends javax.swing.JFrame {
    ...
    public void Cetak() {
        String html = "<H4><center>Laporan Data Rawat Inap Puskesmas</center></h4>" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CetakDataRawatInap.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
