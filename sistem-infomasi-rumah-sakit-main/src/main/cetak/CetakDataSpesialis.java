...
public class CetakDataSpesialis extends javax.swing.JFrame {

    public void Cetak() {
        String html = "<H4><center>Laporan Data Spesialis Puskesmas</center></h4>" +
                "<table width='98%' border='0' align='center' cellpadding='5' cellspacing='1'>" +
                "<tr>" +
                "<td bgcolor='#CCCCCC' align='center'><strong>Kode Spesialis</Strong></td>" +
                "<td bgcolor='#CCCCCC' align='center'><strong>Nama Spesialis</Strong></td>" +
                "<tr>";
        ...
        try {
            ...
            while (res.next()) {
                html = html +
                        "<tr>" +
                        "<td bgcolor='#EEEEEE'>" + res.getString("id_spesialis") + "</td>" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CetakDataSpesialis.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CetakDataSpesialis().setVisible(true);
            }
        });
    }
