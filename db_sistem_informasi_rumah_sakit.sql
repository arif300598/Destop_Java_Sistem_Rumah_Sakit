...
('PSN001', 'Arif Suwanto', 'Laki Laki', 18, 'Jl kencana sari timur', '08990953151'),
('PSN002', 'Testing', 'Laki Laki', 17, 'Jl Arif Rachman Hakim', ' 085687987767'),
('PSN003', 'testing2', 'Perempuan', 23, 'sidoarjo', ' 08990953151');
...
('PRS003', 'PSN001', 'DKT001', 'berlubang', '2024-02-24', 'Rawat Inap'),
('PRS004', 'PSN002', 'DKT002', 'sesak', '2024-06-24', 'Rawat Jalan');
...
--
ALTER TABLE `antrian`
  MODIFY `id_antrian` int(100) NOT NULL AUTO_INCREMENT;
COMMIT;
